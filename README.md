...
- Classical MDS Gram reconstruction error:
  
  $$\frac{\Vert\mathbf{\tilde{X}}^T \mathbf{\tilde{X}} - \mathbf{Z}_{\text{MDS}}^T \mathbf{Z}_{\text{MDS}}\Vert_F}{\Vert\mathbf{\tilde{X}}^T \mathbf{\tilde{X}}\Vert_F}$$
